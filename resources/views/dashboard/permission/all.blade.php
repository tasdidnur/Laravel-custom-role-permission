...
<div class="container-fluid">
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <div class="input-group input-group-sm" style="width: 150px;">
                @isset(Auth::user()->roleInfo->permissionInfo['permission']['permission']['add'])
                   <a class="btn btn-block btn-primary" href="{{ url('dashboard/permission/add') }}">Add Permission</a>
                @endisset   
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu">
                         @isset(Auth::user()->roleInfo->permissionInfo['permission']['permission']['edit'])
                        <a class="dropdown-item" href="{{ url('dashboard/permission/edit/'.$data->id) }}">Edit</a>
                        @endisset
                         @isset(Auth::user()->roleInfo->permissionInfo['permission']['permission']['delete'])
  ...
  <div class="modal fade" id="modal-danger">
    <div class="modal-dialog">
      <form method="post" action="{{url('dashboard/permission/delete')}}">
        @csrf
